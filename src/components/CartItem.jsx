...
function CartItem({ id, name, type, size, imageUrl, totalCount, totalPrice, onDeleteItemCart, onPlusItemCart, onMinusItemCart }) {
  const objId = {
    id,
    type,
    size
...
CartItem.propTypes = {
  ...
  onPlusItemCart: PropTypes.func,
  onMinusItemCart: PropTypes.func
}
